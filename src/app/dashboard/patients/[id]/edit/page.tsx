...
export default function EditPatientPage() {
  ...
  useEffect(() => {
    const fetchPatient = async () => {
      try {
        ...
        toast.error("Failed to load patient", err instanceof Error ? err.message : "An error occurred");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Patient updated successfully", "The patient record has been updated.");
      router.push("/dashboard/patients");
      router.refresh();
    } catch (err) {
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-2 pt-4">
              ...
              <Button type="submit" disabled={updatePatient.isPending} className="flex-1">
